...
const runtimeConfigSchema = z.object({
  ...
  ALANA_RUNTIME_BUILD_AT: z.string().min(1).optional(),
  ALANA_RUNTIME_GIT_SHA: z.string().min(1).optional(),
  ALANA_RUNTIME_MIGRATION_HEAD: z.string().min(1).optional(),
  ...
  QUOTE_EXPORTS_BUCKET: z.string().min(1).default("quote-exports"),
