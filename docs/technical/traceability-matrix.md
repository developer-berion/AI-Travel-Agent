...
| RF-025 Fallback de actividades | `packages/hotelbeds/src/anchor-resolution.ts`, `packages/hotelbeds/src/real-adapter.ts`, `packages/hotelbeds/src/mock-adapter.ts`, `scripts/verify-hotelbeds-connectivity.mjs` | `packages/hotelbeds/src/anchor-resolution.test.ts`, `packages/hotelbeds/src/mock-adapter.test.ts`, `packages/hotelbeds/src/real-adapter.test.ts` |
